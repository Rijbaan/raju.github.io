...
<head>
    ...
    <title>Fufu Info</title>
    <link rel="icon" type="image/png" href="assets/img/fl.png">
</head>
                        ...
                        <!-- <div class="col-lg-8 col-md-12" style="display: none;">
                            <div class="header-top-left">
                                <ul class="contact-info list-style">
                                    <li><i class="flaticon-call"></i> <a href="tel:">(+024) 0000000000</a></li>
                                    <li><i class="flaticon-email-1"></i> <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#2d45484141426d5f4c554c034e4240"><span class="__cf_email__" data-cfemail="8be3eee7e7e4cbf9eaf3eaa5e8e4e6">[email&#160;protected]</span></a></li>
                ...
                <div class="container">
                    <nav class="navbar navbar-expand-md navbar-light">
                        <a class="navbar-brand" href="index.php">
                            <img class="logo-light" src="assets/img/fd.jpg" alt="logo">
                            <!-- <img class="logo-dark" src="assets/img/wlf.png" alt="logo"> -->
                        </a>
                        <div class="collapse navbar-collapse main-menu-wrap" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav ms-auto">
                                ...
                                <li class="nav-item xl-none" style="display: none;">
                            ...
                            <div class="others-options  lg-none">
                                ...
                                <div class="header-btn lg-none" style="display: none;">
                                    <a href="register.html" class="btn style1">Register Now</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mobile-bar-wrap">
                        ...
                        <button class="searchbtn xl-none" type="button" style="display: none;">
                            <i class="flaticon-search"></i>
                        </button>
